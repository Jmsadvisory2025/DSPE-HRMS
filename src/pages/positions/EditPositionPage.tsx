...
const EditPositionPage = () => {
  ...
  const handleSubmit = () => {
    ...
    if (!formData.team_member_id)
      errors.team_member_id = ["Client POC must be selected."];
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <select
                  ...
                  style={{
                    background: theme.background,
                    borderColor: formErrors.client
                      ? theme.destructive
                      : theme.border,
                    color: theme.textPrimary,
                    border: `1px solid ${formErrors.client ? theme.destructive : theme.border}`,
                  }}
                >
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <select
                  ...
                  style={{
                    background: theme.background,
                    borderColor: formErrors.team_member_id
                      ? theme.destructive
                      : theme.border,
                    color: theme.textPrimary,
                    border: `1px solid ${formErrors.team_member_id ? theme.destructive : theme.border}`,
                  }}
                >
                  {!formData.client ? (
                    <option value="" disabled>
