      ...
      <div className="rounded-xl p-6" style={{ background: theme.surface, border: `1px solid ${theme.border}` }}>
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <div className="space-y-2">
                <label className="text-sm font-medium" style={{ color: theme.textSecondary }}>Min Experience</label>
                <Input
                  type="text"
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium" style={{ color: theme.textSecondary }}>Max Experience</label>
                <Input
                  type="text"
          ...
          <div className="space-y-2">
            ...
            <Input
              type="file"
              onChange={(e) => setFormData({ ...formData, description_file: e.target.files?.[0] || null })}
              style={{ background: theme.background, borderColor: theme.border, color: theme.textPrimary }}
              accept=".pdf,.doc,.docx"
            />
            <p className="text-xs" style={{ color: theme.textMuted }}>Upload a PDF or Word document with the JD.</p>
          </div>
