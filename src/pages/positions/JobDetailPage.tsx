...
const JobDetailPage = () => {
  ...
  const { selectedJob: job, detailLoading } = useAppSelector(
    ...
    <div className="space-y-6  pb-10">
      ...
      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <Button 
            size="sm"
            onClick={() => navigate(`/positions/${job.id}/direct-submit`)}
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          >
            ...
            <div>
              ...
              <div
                className="text-sm leading-relaxed whitespace-pre-wrap max-h-96 overflow-y-auto p-4 rounded-lg bg-black/5 dark:bg-white/5"
                style={{ color: theme.textSecondary }}
              >
